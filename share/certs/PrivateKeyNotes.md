...
unlocked to sign the RevolverCoin-Qt.app bundle.
...
allowing somebody to distribute a RevolverCoin-Qt.app or revolvercoin-qt-setup.exe with a valid
...
that the revolvercoin-qt.exe file inside the installer had not been tampered with.
