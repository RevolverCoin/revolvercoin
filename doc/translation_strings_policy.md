...
This document provides guidelines for internationalization of the RevolverCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `revolvercoin_en.ts` remains unchanged.
