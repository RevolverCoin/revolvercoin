RevolverCoin Core version 0.9.2.1 is now available from:

  https://revolvercoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 XRE to 0.01 XRE
...
- Fix "Start revolvercoin on system login"
