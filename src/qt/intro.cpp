...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/revolvercoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("RevolverCoin Core"),
     ...
     * override -datadir in the revolvercoin.conf file in the default data directory
     * (to be consistent with revolvercoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
