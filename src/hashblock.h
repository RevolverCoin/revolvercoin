...
inline unsigned arraysize(Algo *seq) { return 11; }
...
inline uint256 HashX11Evo(const T1 pbegin, const T1 pend, uint32_t time)
{
    static unsigned char pblank[1];

    arith_uint512 hash[17];

	Algo* list = genAlgoSequence(getCurrentAlgoSeq(time, 1462060800));
	//logSequence(list);
