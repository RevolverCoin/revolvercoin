RevolverCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/revolvercoin/files/RevolverCoin/revolvercoin-0.5.4/
...
http://gitorious.org/revolvercoin/revolvercoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix RevolverCoin-Qt notifications under Growl 1.3.
Increase required age of RevolverCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRevolverCoin properly when installing RevolverCoin-Qt over it. (Windows)
