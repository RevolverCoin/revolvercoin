...
#ifndef REVOLVERCOIN_TEST_SCRIPTNUM10_H
#define REVOLVERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from RevolverCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // REVOLVERCOIN_TEST_BIGNUM_H
