...
#if defined(NDEBUG)
# error "RevolverCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "RevolverCoin Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s XRE additional fees, %d delta bytes\n",
...
const CAmount nGenesisBlockRewardCoin = 1 * COIN;
const CAmount nBlockRewardStartCoin = 128 * COIN;
const CAmount nBlockRewardMinimumCoin = 2 * COIN;
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	// Subsidy is cut in half every 86400 blocks (60 days)
...
void ThreadScriptCheck() {
    RenameThread("revolvercoin-scriptch");
