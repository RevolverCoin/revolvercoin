RevolverCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/revolvercoin/files/RevolverCoin/revolvercoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the RevolverCoin
...
New/changed settings (command-line or revolvercoin.conf file)
--------------------------------------------------------
