RevolverCoin Core version 0.9.4 is now available from:

  https://revolvercoin.org/bin/0.9.4/
...
this update is incompatible with the RevolverCoin system and could lead to consensus
forks.

RevolverCoin Core released binaries from https://revolvercoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~revolvercoin/+archive/ubuntu/revolvercoin
- A third-party or self-compiled RevolverCoin Core

upgrade to RevolverCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
